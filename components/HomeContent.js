...
<section id="philomena">
    <div className="bg-gradient-to-tl from-yellow-800 via-yellow-500 to-yellow-200 centerAll">
        ...
        <a href="/philomena"><button className="shadow-lg py-5 px-7 font-bold text-lg transform scale-100 rounded-full bg-yellow-500 md:bg-red-700 text-white hover:scale-105">LEARN MORE</button></a>
        </div>
      </div>
      </div>
      </div>
...
<div class="bg-white centerAll">
 <div class="max-w-3/4">
   <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center">
    ...
    <div class="w-full p-5 centerAll bg-white md:bg-transparent">
        <div class="w-full">
             <h1 class="text-red-700 font-black text-5xl">ABOUT US</h1>
            <p class="text-green-800">The national shrine of St. Philomena in south Florida is operated by the Society of St. Pius X. Owing to the difficulties caused in the past year by the Coronavirus, the shrine was moved 25 miles north from its Little Havana home in Miami north to Our Lady of Victory in Davie, FL. The last Mass for the shrine at the Miami location was March 22nd, 2020.</p>
            <p>“The catalyst for the merging of the two chapels was Covid-19,” said Fr. Samuel Fabula, the pastor of Our Lady of Victory. “The shutdowns and restrictions for Miami in Dade County were more restrictive than those for Davie in Broward County. When the faithful of St. Philomena were denied access to the church, the decision was made to combine the two parishes at Our Lady of Victory, which is also the larger chapel.”</p>
              <a href="/about"><button class="bg-red-600 hover:bg-red-800 text-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider">
                   CONTINUE READING
                  </button>
              </a> 
        </div>
...
<div>
<section id="contact">
<div class="bg-gradient-to-tl from-blue-700 via-blue-300 to-white centerAll">
    <div class="max-w-3/4">
        <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center">
            <div class="pt-20">
                <div class="centerAll">
                <StaticImage class="relative w-3/4 mb-0" src="../images/Our_lady_of_victory_crop.png" alt="Our Lady of Victory" />
                </div>
            </div>
        
          
                    <div class="w-full p-5 centerAll bg-blue-900 md:bg-transparent">
                        <div>
                             <h1 class="text-white font-black text-5xl">SCHEDULE A VISIT</h1>
                        <p class="text-white">Planning a visit or pilgrimage to the Shrine? Tell us about it!</p>
                            <div>
                                  <form id="appointment" action="#" method="">
                                                    <div class="grid grid-cols-2 gap-4 max-w-xl m-auto">       
                                                        <div class="col-span-2 lg:col-span-1">
                                                        <input type="text" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="Name"/>
                                                        </div>
                            
                                                        <div class="col-span-2 lg:col-span-1">
                                                        <input type="tel" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="Telephone"/>
                                                        </div>
                                                                        
                                                        <div class="col-span-2 lg:col-span-1">
                                                        <input type="email" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="E-Mail"/>
                                                        </div>
                            
                                                        <div class="col-span-2 lg:col-span-1">
                                                        <input type="text" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="Language"/>
                                                        </div>
                                        
                                                        <div class="col-span-2 lg:col-span-1">
                                                        <input type="date" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="Date"/>
                                                        </div>
                                            
                                                        <div class="col-span-2 lg:col-span-1">
                                                        <input type="time" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="Time"/>
                                                        </div>										  
                                            
                                                        <div class="col-span-2">
                                                        <textarea cols="30" rows="4" class="text-gray-500 border-solid border-gray-400 border p-3 md:text-xl w-full" placeholder="Message"></textarea>
                                                        </div>
                            
                                                        <div class="col-span-2 text-center">
                                                        <button class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider">
                                                        SUBMIT
                                                        </button>   
                                                        </div>
                                                    </div>
