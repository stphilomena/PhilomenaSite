...
const NewMenu = () => {
    ...
    <div className="bg-gray-200  border-b-2 border-gray-400 w-screen centerAll h-10 py-5">
        ...
        <div className=" flex">
            ...
            <div className={"py-2 px-3 md:px-3 lg:px-5 h-full " + (cartLength>0? "bg-red-500 text-white hover:bg-red-700" : "bg-gray-300 text-gray-600")} ><Link to="/CartPage"><BsCart3 size="1.5em"/></Link></div>
        </div>
        </div> 
        </div>
        </div>
