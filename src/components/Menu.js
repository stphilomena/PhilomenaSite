...
const NewMenu = () => {
    ...
    <div className="bg-gray-200  border-b-2 border-gray-400 w-screen centerAll h-10 py-5">
        ...
        <div className={"text-white bg-red-600 z-50 hover:bg-red-800 centerAll fixed top-10 right-0 w-20 h-20 transform transition duration-300 rounded-l-xl  md:p-5 lg:p-5  " + (cartLength>0? "translate-x-0" : "-translate-x-20")} ><Link to="/CartPage"><BsCart3 size="2em"/></Link></div>
        </div>
        </div>
