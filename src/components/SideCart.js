...
const SideCart = () => {
    ...
    return (
        <div className={"fixed top-10 right-0 w-96 overflow-x-hidden bg-red-500"}>
            <div
                className={"flex relative bg-red w-80 shadow-xl transition-all duration-300 ease-in " + (!expanded ? "-right-80 ml-16" : "-right-16")}>
                <div id="cartButton"
