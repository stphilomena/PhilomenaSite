...
<div className="centerAll">
    ...
    <a href="#checkout">
        ...
        <script src="https://www.paypal.com/sdk/js?&client-id=AWg5MHVS4Y01l66Z1Vc0ZCwjuL9VVuXm550CRVnizukRjuZGYwvFrhcdqoXNoKda3kMKREy14Va_WGRU&merchant-id=<Merchant-ID>&currency=USD"></script>
        <script>
        paypal.Buttons({
