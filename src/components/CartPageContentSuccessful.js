...
<div>
<div className="text-green-500 font-black text-4xl centerAll py-10">THANK YOU!</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="centerAll ">
        <button className="bg-blue-500 w-full text-2xl text-white font-bold p-5 px-10 rounded-full hover:bg-blue-600">RETURN TO SHOP</button></div>
    <div className="centerAll ">
