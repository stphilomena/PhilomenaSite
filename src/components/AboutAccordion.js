  ...
  return (
      <>
          <h2 className={expanded?'title is-expanded':'title'}>
              <a href={'#'} onClick={()=>setExpanded(!expanded)}>{title}</a>
          </h2>
          <div className={expanded?'content is-expanded':'content'}>
              {children}


<div className="content.is-expanded">
